# PetriNet
<div id="intro" class="box generalbox boxaligncenter"><div class="no-overflow"><h2 id="wprowadzenie">Wprowadzenie</h2>
...
<pre class="sourceCode java"><code class="sourceCode java"><span class="kw">package petrinet;</span>
...
<span class="kw">public</span> <span class="kw">class</span> PetriNet&lt;T&gt; {

    public PetriNet(Map&lt;T, Integer&gt; initial, <span class="dt">boolean</span> fair) {
        ...
    }
...
public class Transition&lt;T&gt; {
    ...
    public Transition</span>(Map&lt;T, Integer&gt; input, Collection&lt;T&gt; reset, Collection&lt;T&gt; inhibitor, Map&lt;T, Integer&gt; output) {
        ...
    }
